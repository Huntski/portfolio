<template>
    <div class="project-gallery-item aspect-[3/2] rounded-lg relative group overflow-hidden cursor-pointer hover:shadow-lg border border-gray-300">
        <div class="absolute top-0 left-0 h-full bg-gradient-to-b from-[#00000020] to-[#00000095] flex flex-col p-5 w-full rounded-lg z-10 opacity-0 group-hover:opacity-100 transition-opacity">
            <ProjectAttributes :attributes="props.project.attributes" />
...
import {ProjectItem} from "@/views/HomeView/ProjectGallery/ProjectGallery.vue"
import ProjectAttributes from "@/views/HomeView/ProjectGallery/ProjectGalleryItem/ProjectAttributes"
